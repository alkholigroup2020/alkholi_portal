  ...
  <div class="pa-0 ma-0">
    ...
    >
      ...
      <div class="content py-5 mt-n11">
        ...
        <v-row class="mt-3 px-8 primary--text">
        ...
        <v-row class="pb-3">
          <v-col cols="12" justify-center>
            <div class="text-center">
              <v-avatar tile width="185" size="100" class="px-3 pt-2">
                <v-img
                  src="/bcard-logos/MX realtiy logo.png"
                  alt="Company Logo!"
                  position="center"
                  contain
                  eager
              ...
              <v-avatar tile width="200" size="100" class="px-3">
                <v-img
