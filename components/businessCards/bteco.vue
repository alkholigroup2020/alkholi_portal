    ...
    >
      <div class="upDecoration">
        <div class="text-center">
          <v-avatar tile width="210" size="120" class="mt-n1">
            <v-img
              :src="
                result.companyLogo !== 'undefined'
                  ? `${$config.baseURL}/business-cards-api/business-cards/${result.companyLogo}`
                  : '/bcard-logos/BuildingTec Elevators_BasicLogo_White_Color.png'
              "
              alt="Company Logo!"
              position="center"
              contain
      ...
      <div class="content py-5 mt-n12">
        <v-row class="mt-n16">
          ...
          <v-col cols="12" class="d-flex justify-center pb-0">
            <p
              class="primary--text mb-1 mt-n5 text-center"
          ...
          <v-col cols="12" class="mt-n5 d-flex justify-center">
            <p
              class="primary--text mb-2 text-center"
        ...
        <v-row style="font-size: 20px" class="pb-4">
          ...
          <v-col
            v-if="firstLandLineNumber != 'undefined'"
            cols="12"
            class="d-flex justify-center pb-1"
          >
            <a :href="`tel:00966${firstLandLineNumber}`" class="textColor">
              <p class="mb-0">
            ...
            <a
              ...
              :href="`tel:00966${secondLandLineNumber}`"
              class="textColor"
            >
              <p class="mb-0">{{ `${secondLandLineNumber}` }}</p>
            </a>
          </v-col>
          <v-col cols="12" class="d-flex justify-center pb-1">
...
export default {
  ...
  methods: {
    splitLandLines() {
      ...
      this.firstLandLineNumber = A[0]
      this.secondLandLineNumber = A[2]
    },
  },
}
</script>
...
.upDecoration {
  background-color: rgb(239, 62, 45);
  height: 190px;
}
.textColor {
  color: rgb(239, 62, 45);
