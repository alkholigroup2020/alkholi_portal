  ...
  <v-container fluid class="pt-0">
    ...
    <v-row class="my-0">
      <v-col cols="12" sm="8" lg="6" xl="4" class="py-0">
        <v-form @submit.prevent="addCOCAdmin">
          <div class="d-flex">
            <v-text-field
              v-model="adminMember"
              ...
              outlined
              dense
              :placeholder="$t('adminPage.coc.formInput')"
            ></v-text-field>
            <v-btn
              type="submit"
              small
      ...
      <v-col cols="12" class="py-0">
        ...
        >
          <template #default>
            ...
            <tbody>
              <tr v-for="member in cocAdmins" :key="member._id">
                ...
                <td>
                  <cocDelete :employee="member.employeeID" />
                </td>
              </tr>
            </tbody>
          </template>
...
export default {
  ...
  computed: {
    ...mapState({
      cocAdmins: (state) => state.administration.cocAdmins.cocAdmins,
    }),
  },
      ...
      try {
        ...
        if (A !== '') {
          this.$nextTick(async () => {
            ...
            await this.$store.dispatch(
              'administration/cocAdmins/addCOCAdmin',
              employeeCode
            )
            this.adminMember = ''
            await this.getCOCAdmins()
